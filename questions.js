window.QUIZ_QUESTIONS = [
  {
    ...
    "codeType": "javascript",
    "answerText": "4",
    "explanation": "var는 함수 스코프를 가지고 있어 외부에 선언된 let x의 변수명과 겹쳐 에러가 발생한다.",
    "choices": [
      "10",
      "20",
      "undefined",
  ...
  },
  {
    "id": "q005",
    "kind": "short",
    "question": "배열의 각 요소를 순회하면서 특정 작업을 수행하는 메서드로 return 값을 반환하지 않는 메서드 이름을 작성하시오. (정답은 대소문자를 구분하여 정확하게 작성하시오.)",
    "passage": "",
    "codeType": "none",
    "answerText": "forEach",
  ...
  },
  {
    ...
    "codeType": "javascript",
    "answerText": "콜백함수 내부의 this 가 window가 되기 때문에 콜백함수를 화살표 함수로 수정하여 내부의 trackList를 가리킬 수 있도록 해야 한다.",
  ...
  },
  {
    ...
    "codeType": "javascript",
    "answerText": "10",
    "explanation": "const 키워드는 '블록 스코프'를 가진다. if 블록 내에서 선언된 **const x = 20**은 블록 외부의 **const x = 10**과 다른 변수이다. if 블록이 종료된 후, ⓑ 지점의 console.log(x)는 전역(또는 외부) 스코프의 x 값인 10을 출력한다."
  },
  {
    "id": "q028",
    "kind": "multiple",
  ...
  },
  {
    ...
    "codeType": "javascript",
    "answerText": "1",
    "explanation": "빈 문자열은 거짓으로 평가되지만, \"0\"은 값이 있는 문자열이므로 참으로 평가되어 \"True\"가 출력된다.",
    "choices": [
      "True Value",
      "False Value",
      "아무것도 출력되지 않는다.",
  ...
  },
  {
    ...
    "codeType": "javascript",
    "answerText": "2",
    "explanation": "for…in 반복문은 객체의 키 값을 순서대로 출력하게되며 string 은 인덱스가 출력된다.",
    "choices": [
      "a b c",
      "0 1 2",
      "1 2 3",
